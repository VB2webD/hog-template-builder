...
export const towerData:  Record<number, Tower> = {
    ...
    // Elf
    29: {name: "Druid of Talon", tier: 1, image: "/towers/elf/claw.webp", slots: 4, race: Race.Elf},
    30: {name: "Druid of Claw", tier: 1, image: "/towers/elf/talon.webp", slots: 4, race: Race.Elf},
    31: {name: "Dryad", tier: 1, image: "/towers/elf/dryad.webp", slots: 4, race: Race.Elf},
    32: {name: "Avatar of Vengeance", tier: 1, image: "/towers/elf/avaVengeance.webp", slots: 4, race: Race.Elf},
    33: {name: "Warden", tier: 2, image: "/towers/elf/warden.webp", slots: 5, race: Race.Elf},
    34: {name: "Faery Drake", tier: 2, image: "/towers/elf/fd.webp", slots: 5, race: Race.Elf},
    35: {name: "Huntress", tier: 2, image: "/towers/elf/huntress.webp", slots: 5, race: Race.Elf},
    36: {name: "Malfurion", tier: 2, image: "/towers/elf/malf.webp", slots: 5, race: Race.Elf},
    37: {name: "Keeper of the Grove", tier: 2, image: "/towers/elf/keeper.webp", slots: 5, race: Race.Elf},
    38: {name: "Maiev", tier: 3, image: "/towers/elf/maiev.webp", slots: 6, race: Race.Elf},
    39: {name: "Demon Hunter", tier: 3, image: "/towers/elf/dh.webp", slots: 6, race: Race.Elf},
    40: {name: "Priestess of the Moon", tier: 3, image: "/towers/elf/potm.webp", slots: 6, race: Race.Elf},
    41: {name: "Ancient of Lore", tier: 3, image: "/towers/elf/aol.webp", slots: 6, race: Race.Elf},
    // Undead
